...
}).AddJwtBearer(x =>
{
    ...
    x.TokenValidationParameters = new TokenValidationParameters {
        ...
        ValidIssuer = "http://localhost:2137",
        ValidAudience = "http://localhost:2137",
        IssuerSigningKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("lkhlkjjkjljjhfjdhfhdkfhdfhkdfdjhfdhfdfkjdhf")),
